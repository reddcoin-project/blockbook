...
The legacy API is currently (as of Blockbook v0.4.1) also accessible without the _/v1/_ prefix, however in the future versions the version-less access will be removed.
